...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        actionExportAsPLY = new QAction(MainWindow);
        actionExportAsPLY->setObjectName("actionExportAsPLY");
        ...
        multiRes_factor = new QSpinBox(layoutWidget1);
        ...
        menuSave->addAction(actionExportAsPLY);
...
#endif // QT_CONFIG(tooltip)
        actionExportAsPLY->setText(QCoreApplication::translate("MainWindow", "Export eroded model as PLY", nullptr));
