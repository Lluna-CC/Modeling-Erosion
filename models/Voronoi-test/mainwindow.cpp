...
void MainWindow::createActions()
{
    ...
    connect(ui->refreshParams, SIGNAL(clicked()), this, SLOT(refreshErosionParams()));
}
...
void MainWindow::computeVoronoi() {
    ...
    widget -> setDecomposition(cellDecomp, &hf, phi, theta);
...
void MainWindow::refreshErosionParams() {
    double phi = ui -> phi_spinbox -> value();
    double theta = ui -> theta_spinbox -> value();
    widget -> refreshErosionParams(phi, theta);
}