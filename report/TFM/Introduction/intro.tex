...
results in a QT application using OpenGL for rendering. All deteils of our 
application will be described in \ref{sec:implementationResults}, but 
we also leave all implemented code open to everyone in the \href{https://github.com/Lluna-CC/Modeling-Erosion}{Github page of the project}
